<?php
    // here $post is coming from the function from where this file is included. look in the add_inner_meta_boxes() function of class.mv-testimonials-cpt.php file
	...
	<tr>
		...
		<td>
			<input
				...
				value="<?php echo ( isset ( $user_url ) ) ? esc_html( $user_url ) : '' ?>"
			>
		</td>
	</tr>
</table>